...
app.post('/book/read', function(req, res) {
    ...
    var options = {
        method: 'GET',
        uri: geturl,
        headers: { 'Cookie': 'uLocale=zh_CN; app_id=mi_wap; build=8888; device_id=D950FH275FLEFLJX; user_type=2; device_hash=76dc2d8d805f607f7e10f8596e06730a; user_id=1236127735; token=s4xOpaiEvnQH-8h_y541nhFPb6E-Nf3j_8ZBQDTS5gYkuzGxs5cko2iW-tJ9Mvl8; Hm_lvt_a1d10542fc664b658c3ce982b1cf4937=1489632936,1489720605,1489996190,1490060009; Hm_lpvt_a1d10542fc664b658c3ce982b1cf4937=1490077093' },
        json: true
    }
    request(options)
        .then(body => {
...
app.get('/api/searchpage', function(req, res) {
    var freeSet = {
